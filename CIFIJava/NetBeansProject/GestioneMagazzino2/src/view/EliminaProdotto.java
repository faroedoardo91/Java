...
public class EliminaProdotto extends javax.swing.JInternalFrame {
    ...
    private void btnInviaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInviaActionPerformed
        ...
        try {
            ...
            boolean flag = dao.delete(p.getCodice());
    ...
    private void btnCercaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCercaActionPerformed
        ...
        try {
            ...
            DaoProdotto dao = new DaoProdotto();
            p = dao.getById(Integer.parseInt(txtCerca.getText()));

            if (p != null) {
                txtCodice.setText(p.getCodice() + "");
                txtCategoria.setText(p.getCategoria().getNome());
